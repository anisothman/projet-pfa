...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .localis-root.dark .nav {
    background: rgba(17,24,39,0.95);
  }

  .localis-root.dark .analytics-card,
  .localis-root.dark .feature-card,
  .localis-root.dark .step-icon-badge,
  .localis-root.dark .stat-badge,
  .localis-root.dark .stat-badge2,
  .localis-root.dark .btn-hero-secondary {
    background: #1f2937;
  }
  ...
  .localis-root.dark .btn-signin,
  .localis-root.dark .btn-moon,
  .localis-root.dark .card-title,
  .localis-root.dark .feature-name,
  .localis-root.dark .step-content h3 {
    color: var(--text-dark);
  }

  .localis-root.dark .icon-blue { background: #1e293b; }
  .localis-root.dark .icon-purple { background: #2e1065; }
  .localis-root.dark .icon-green { background: #064e3b; }
  .localis-root.dark .icon-orange { background: #7c2d12; }
  ...
  .nav-logo-text { font-size: 17px; font-weight: 700; color: var(--blue); }
  ...
  .btn-signin { background: none; border: none; font-size: 14px; font-weight: 600; cursor: pointer; color: var(--text-dark); font-family: 'Sora', sans-serif; }
  .btn-primary {
  ...
  .hero-logo-icon {
    ...
    background: linear-gradient(135deg, #7048E8, #3B5BDB);
    display: flex; align-items: center; justify-content: center;
    box-shadow: 0 8px 32px rgba(59,91,219,0.25);
    margin-bottom: 28px;
    position: relative;
  }
  ...
  .hero p {
    ...
    margin-bottom: 36px; font-weight: 400; font-family: 'Inter', sans-serif;
  }
  ...
  .btn-hero-primary:hover { background: var(--blue-dark); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(59,91,219,0.4); }
  .btn-hero-secondary {
  ...
  .bar {
    ...
    background: linear-gradient(180deg, #93ACFF, #3B5BDB);
    opacity: 0.7;
  ...
  .stat-badge2 {
    position: absolute; right: 28px; top: 130px;
    background: white; border-radius: 14px; padding: 12px 18px;
    box-shadow: 0 4px 20px rgba(0,0,0,0.1);
    display: flex; flex-direction: column; gap: 2px;
  }
  ...
  .section-title {
    ...
    color: var(--text-dark); margin-bottom: 16px; letter-spacing: -1px;
    line-height: 1.1;
  }
  .section-sub {
    text-align: center; font-size: 16px; color: var(--text-gray);
    font-family: 'Inter', sans-serif; margin-bottom: 72px;
  }
  ...
  .steps { max-width: 700px; margin: 0 auto; display: flex; flex-direction: column; gap: 64px; }
  ...
  .cta-section {
    background: linear-gradient(135deg, #3B5BDB 0%, #2F4AC2 40%, #1E3A8A 100%);
  ...
  .footer-bar {
    background: linear-gradient(135deg, #3B5BDB 0%, #2F4AC2 100%); padding: 40px 80px;
    display: flex; align-items: center; justify-content: space-between;
    ...
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id={mainBlueGrad} x1="0" y1="0" x2="100" y2="100">
          <stop stopColor="#5b7beb" />
          <stop offset="0.4" stopColor="#3b5bdb" />
          <stop offset="1" stopColor="#2b4bcb" />
        </linearGradient>
        <linearGradient id={lightBlueGrad} x1="0" y1="0" x2="100" y2="100">
          <stop stopColor="#ffffff" />
          <stop offset="1" stopColor="#e8edfc" />
        </linearGradient>
      </defs>
      ...
      <path
        d="M50 28 C41 28 35 35.5 35 43.5 C35 52.5 50 68 50 68 C50 68 65 52.5 65 43.5 C65 35.5 59 28 50 28Z"
      ...
      <circle cx="46.5" cy="44" r="1.2" fill="#5b7beb" />
      <circle cx="54.5" cy="44" r="1.2" fill="#5b7beb" />
      ...
      <circle cx="45" cy="32.5" r="2" fill="#5b7beb" />
      <circle cx="55" cy="32.5" r="2" fill="#5b7beb" />

      <path
        d="M50 22 L51.5 26.5 L56.5 27 L52.5 30.5 L53.5 35 L50 32.5 L46.5 35 L47.5 30.5 L43.5 27 L48.5 26.5 Z"
        fill="white"
        opacity="0.95"
      />
...
const DBIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <ellipse cx="12" cy="6" rx="8" ry="3" fill="#3B5BDB"/>
    <path d="M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6" fill="#3B5BDB" fillOpacity="0.5"/>
    <path d="M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6" fill="#3B5BDB" fillOpacity="0.3"/>
  </svg>
);

const BrainIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M9 3C6.24 3 4 5.24 4 8c0 1.5.6 2.85 1.57 3.83C4.6 12.57 4 13.71 4 15c0 2.76 2.24 5 5 5h2v-4.5L9.5 14H8v-2h1.5L11 10.5V9h2v1.5L14.5 12H16v2h-1.5L13 15.5V20h2c2.76 0 5-2.24 5-5 0-1.29-.6-2.43-1.57-3.17C19.4 10.85 20 9.5 20 8c0-2.76-2.24-5-5-5-1.45 0-2.75.62-3.67 1.6C10.41 3.62 9.71 3 9 3z" fill="#7048E8"/>
  </svg>
);

const CheckListIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <rect x="3" y="3" width="18" height="18" rx="4" fill="#22C55E" fillOpacity="0.2"/>
    <path d="M7 12l3 3 7-7" stroke="#22C55E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M7 7h10M7 17h5" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/>
  </svg>
);

const DocIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" fill="#F97316" fillOpacity="0.8"/>
    <path d="M14 2v6h6" fill="#F97316" fillOpacity="0.4"/>
...
export default function LocalisAI() {
 ...
 const generatePDF = () => {
  ...
  link.href = url;
  link.download = "rapport_diagnostic_localis.pdf";
  link.click();
    ...
    <div className={`localis-root ${isDarkMode ? "dark" : ""}`}>
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <button className={`nav-link ${activeSection === "pricing" ? "active" : ""}`} onClick={() => scrollTo("pricing")}>Pricing</button>
        </div>
      ...
      <section id="home" className="hero">
        <div className="hero-content">
          ...
          <div className="hero-badge fade-up">
            <span>✦</span> AI-Powered Business Intelligence
          </div>
          <h1 className="fade-up delay-1">Localis AI</h1>
          <h2 className="fade-up delay-2">From Local Data to Smart Decisions</h2>
          <p className="fade-up delay-2">
            Harness the power of AI to analyze your local business using Google data.
            Get actionable insights, diagnostic reports, and strategic action plans in minutes.
          </p>
          <div className="hero-btns fade-up delay-3">
            <button className="btn-hero-primary" onClick={generatePDF}>📄 Télécharger le Rapport PDF</button>
          ...
          <div className="analytics-card fade-up delay-2">
            ...
            <div className="chart-area">
              ...
              <svg className="line-svg" viewBox="0 0 440 200" preserveAspectRatio="none">
                <polyline
                  points="30,160 95,140 160,120 225,100 290,108 355,70 420,50"
                  fill="none" stroke="#7048E8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"
                />
                {[30,95,160,225,290,355,420].map((x,i) => {
                  const ys = [160,140,120,100,108,70,50];
                  return <circle key={i} cx={x} cy={ys[i]} r="5" fill="#7048E8" />;
                })}
              </svg>
            </div>
            ...
            <div className="stat-badge2">
              ...
              <span className="stat-value2">127</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="section features-section">
        ...
        <p className="section-sub">Comprehensive tools and insights powered by advanced AI to help your business thrive.</p>
        <div className="features-grid">
          {[
            ...
            { icon: <BrainIcon />, bg: "icon-purple", name: "AI Diagnostic Analysis", desc: "Powered by Gemini AI to identify strengths, weaknesses, and hidden opportunities in your business performance." },
            { icon: <CheckListIcon />, bg: "icon-green", name: "Strategic Action Plans", desc: "Get prioritized short, medium, and long-term recommendations tailored to your business needs." },
      ...
      <section id="how" className="section how-section">
        ...
        <div className="steps">
          {[
            { n: "01", icon: <SearchIcon />, title: "Enter Business Details", desc: "Simply provide your business name and location. We'll find all relevant data automatically." },
            ...
            <div key={i} className="step fade-up" style={{ animationDelay: `${i * 0.15}s` }}>
      ...
      <section id="pricing" className="cta-section">
        ...
        <p className="cta-sub">
          Join hundreds of businesses making smarter decisions with AI-powered insights.
          Get quick results with your first analysis.
        </p>
        ...
        <button className="btn-cta">Start Free Analysis →</button>
